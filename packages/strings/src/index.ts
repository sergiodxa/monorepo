 ...
 * slugs, and grapheme-safe text operations, re-exported from one module. Every
 * vocabulary is passed in per inflector or titleizer instead of registered
 * globally, so results never depend on which module imported first.
 *
