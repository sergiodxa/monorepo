 ...
 * below `1` darken and above `1` brighten; `0` is solid black. Composes through
 * the shared composite `filter` declaration, so it combines with every other
 * filter utility instead of overwriting them.
 *
