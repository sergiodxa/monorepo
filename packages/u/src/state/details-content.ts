...
/**
 * Applies the given utilities to a `<details>` element's `::details-content`
 * pseudo-element, the region holding everything after the `<summary>`.
 * Combine with `u.open()`'s selector to scope styles to the open state.
 *
