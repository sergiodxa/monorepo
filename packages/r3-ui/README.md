...
| `Command` (+ `.Input`, `.List`, `.Item`, `.Empty`)                                                                                                               | A bordered, elevated panel listing selectable rows for searching and choosing among a set of actions; pairs with the `commandFilter()` mixin for as-you-type narrowing and match highlighting.                      |
