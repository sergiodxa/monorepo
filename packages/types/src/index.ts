 ...
 * the three JSON boundary types for writing, reading and the round trip between
 * them, and the type-level `any` check. Types only, so every consumer imports
 * from here with `import type`.
 *
