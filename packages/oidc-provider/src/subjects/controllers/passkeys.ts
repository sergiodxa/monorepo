 ...
 */
export const index: Action<typeof routes.api.subjects.passkeys.index> = createAction(
 ...
 */
export const update: Action<typeof routes.api.subjects.passkeys.update> = createAction(
 ...
 */
export const destroy: Action<typeof routes.api.subjects.passkeys.destroy> = createAction(
