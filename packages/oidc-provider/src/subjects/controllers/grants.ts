 ...
 */
export const index = createAction(routes.api.subjects.grants.index, async (ctx) => {
	let { params, log } = ctx;
 ...
 */
export const destroy = createAction(routes.api.subjects.grants.destroy, async (ctx) => {
	let { params, log } = ctx;
