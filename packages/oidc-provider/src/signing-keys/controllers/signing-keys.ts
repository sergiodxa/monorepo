 ...
 */
export const index: Action<(typeof routes.api)["signing-keys"]["index"]> = createAction(
 ...
 */
export const create: Action<(typeof routes.api)["signing-keys"]["create"]> = createAction(
 ...
 */
export const rotate: Action<(typeof routes.api)["signing-keys"]["rotate"]> = createAction(
 ...
 */
export const destroy: Action<(typeof routes.api)["signing-keys"]["destroy"]> = createAction(
