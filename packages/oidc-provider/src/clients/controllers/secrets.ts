 ...
 */
export const index: Action<typeof routes.api.clients.secrets.index> = createAction(
	...
	async (ctx) => {
		...
		let secrets = await Secret.list(ctx.db, clientId);
 ...
 */
export const create: Action<typeof routes.api.clients.secrets.create> = createAction(
 ...
 */
export const destroy: Action<typeof routes.api.clients.secrets.destroy> = createAction(
	...
	async (ctx) => {
		...
		try {
			await Secret.destroy(ctx.db, id);
