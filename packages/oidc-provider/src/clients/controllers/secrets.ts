 ...
 */
export const index = createAction(routes.api.clients.secrets.index, async (ctx) => {
	let { params, log } = ctx;
 ...
 */
export const create = createAction(routes.api.clients.secrets.create, async (ctx) => {
 ...
 */
export const destroy = createAction(routes.api.clients.secrets.destroy, async (ctx) => {
	let { params, log } = ctx;
