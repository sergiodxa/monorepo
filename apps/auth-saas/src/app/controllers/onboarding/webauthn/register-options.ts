...
/**
 * Proxy WebAuthn registration options to platform tenant DO.
 */
export default action<"POST", "/onboarding/webauthn/register/options">(
	async ({ request, formData }) => {
		...
		url.pathname = "/webauthn/register/options";
