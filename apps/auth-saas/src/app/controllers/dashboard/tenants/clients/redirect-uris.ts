					...
					content: `
						...
						<form method="POST" action="/dashboard/tenants/${tenant.id}/clients/${params.clientId}/redirect-uris" class="bg-white rounded-lg border p-6 space-y-4 max-w-lg">
							<div>
								...
								<p class="text-gray-500 text-xs mt-1">The URL where users will be redirected after authentication</p>
							</div>
							...
							<div>
								...
								<p class="text-gray-500 text-xs mt-1">Restrict this URI to a specific environment</p>
							</div>
