...
export default {
		...
		features: {
			...
			list: {
				first: {
					...
					description:
						"Rastree sus servicios 24/7 con 99.9% de confiabilidad en el monitoreo. Obtenga métricas detalladas e información de rendimiento de un vistazo.",
				},
				second: {
		...
		pricing: {
			...
			howItWorks: {
				...
				list: {
					...
					second: {
						...
						description: "{{blockPrice}} por cada {{blockSize}} pings adicionales",
					},
			...
			calculator: {
				...
				stats: {
					...
					additionalPingsCost: "{{pings}} pings × {{blockPrice}} por {{blockSize}}",
		...
		faq: {
			...
			list: {
				...
				seventeenth: {
					...
					a: "Se te cobrará {{blockPrice}} por cada {{blockSize}} pings por encima de los {{included}} incluidos en tu suscripción.",
				},
	...
	monitorDetail: {
		...
		stats: {
			...
			p99ResponseTime: "Tiempo de respuesta P99",
	...
	page: {
		dashboard: {
			...
			stats: {
				...
				sslMonitors: {
					label: "Monitores SSL",
					description: "{{valid}} válidos, {{expiring}} por expirar, {{expired}} expirados",
				},
			},
		...
		monitor: {
			...
			stats: {
				...
				uptime: {
					label: "Porcentaje de Uptime",
					description: "Uptime general del monitor",
				},
			...
			form: {
				fields: {
					...
					recordType: {
						...
						description: "El tipo de registro DNS a verificar.",
					},
					...
					expectedValue: {
						...
						description:
							"Opcional. Alertar si el valor resuelto no coincide. Dejar vacío para rastrear cambios.",
					},

					interval: {
						label: "Intervalo de verificación",
						description: "Con qué frecuencia verificar el registro DNS.",
						options: {
							"5m": "5 minutos",
							"15m": "15 minutos",
							"30m": "30 minutos",
					...
					isEnabled: {
						...
						description: "Comenzar a monitorear este registro DNS inmediatamente.",
					},
				},
		...
		editDnsMonitor: {
			...
			form: {
				fields: {
					...
					isEnabled: {
						label: "Habilitar monitoreo",
						description: "Si monitorear activamente este registro DNS.",
					},
				},
			...
			dangerZone: {
				...
				deleteDescription:
					"Esto también elimina su historial de resultados de verificación. Esto no se puede deshacer.",
			},
		},
		...
		account: {
			...
			teams: {
				title: "Sus Equipos",
				description: "Equipos de los que es miembro.",
				...
				empty: {
					...
					description: "Cree un equipo para comenzar a monitorear sus servicios.",
					cta: "Crear Equipo",
				},
				...
				table: {
					...
					confirmation: {
						leaveTeam: "¿Está seguro de que desea abandonar {{name}}?",
					},
				},
			},
		},
			...
			form: {
				fields: {
					...
					preset: {
						...
						description: "Seleccione un horario común o ingrese una expresión personalizada.",
						options: {
							custom: "Personalizado",
							...
							everyHour: "Cada hora",
							everyDay: "Cada día a medianoche",
							everyWeek: "Cada semana (domingo a medianoche)",
						},
					},
					gracePeriod: {
