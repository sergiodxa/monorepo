 ...
 * and description into concrete ones, falling back to generic "not found" copy. It
 * exists to keep 404 presentation data preparation out of the controller and view.
 *
...
export default class NotFoundViewModel {
	static default(input: NotFoundViewModel.DefaultInput): NotFoundViewModel.DefaultOutput {
		return {
			...
			description:
				input.description || "The page you're looking for doesn't exist or may have moved.",
		};
	}
}
