 ...
 * records the response, and guarantees logs are flushed on both success and error
 * paths. It exists so every handler can log through `ctx.logger` instead of the
 * console directly.
 *
