...
export const tcpMonitorsIndex = createAction(routes.api.v1.tcpMonitorsIndex, async (ctx) => {
...
export const tcpMonitorsCreate = createAction(routes.api.v1.tcpMonitorsCreate, async (ctx) => {
