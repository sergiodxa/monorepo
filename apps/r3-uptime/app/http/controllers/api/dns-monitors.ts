...
export const dnsMonitorsIndex = createAction(routes.api.v1.dnsMonitorsIndex, async (ctx) => {
...
export const dnsMonitorsCreate = createAction(routes.api.v1.dnsMonitorsCreate, async (ctx) => {
