...
export const apiKeysIndex = createAction(routes.api.v1.apiKeysIndex, async (ctx) => {
...
export const apiKeysCreate = createAction(routes.api.v1.apiKeysCreate, async (ctx) => {
	let db = getServiceContainer().get(Database);
