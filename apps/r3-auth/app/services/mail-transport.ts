 ...
 * class, since `@sdxc/service-container` keys services by a runtime class, which only a class provides.
 *
 ...
 * in `app/lib/container.ts` with a `@sdxc/mail` transport that satisfies this
