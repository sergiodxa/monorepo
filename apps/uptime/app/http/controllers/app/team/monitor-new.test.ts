...
let { handler } = (await import("./monitor-new")).default as { handler: RequestHandler<any> };
...
describe("monitorNew", () => {
	test("renders the empty new-monitor form", async () => {
		...
		expect(body).toContain("Create Monitor");
