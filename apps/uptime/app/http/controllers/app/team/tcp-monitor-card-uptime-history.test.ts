...
let { handler } = (await import("./tcp-monitor-card-uptime-history")).default as {
...
async function send(
	...
	router.map(routes.app.team.tcpMonitors.cards.uptimeHistory, {
	...
	let request = new Request(
		new URL(
			routes.app.team.tcpMonitors.cards.uptimeHistory.href({ team: team.slug, monitorId }),
			"https://uptime.test",
		),
	);
...
describe("tcp-monitor-card-uptime-history", () => {
