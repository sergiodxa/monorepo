 ...
 * wrong-scope keys, and that a monitor belonging to another team always 404s, leaving
 * its data untouched.
 *
...
let { default: monitorController } = await import("~/app/http/controllers/api/monitor");
