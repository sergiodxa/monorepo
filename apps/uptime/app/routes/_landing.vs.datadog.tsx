...
export function loader() {
	return {
		meta: [
			{ title: "Uptime vs Datadog | Focused Uptime Monitoring Alternative" },
			{
				name: "description",
				content:
					"Compare Uptime and Datadog for uptime monitoring. Get focused monitoring without the complexity of a full observability platform. See features, pricing, and find out which is right for you.",
			},
		],
	};
}
