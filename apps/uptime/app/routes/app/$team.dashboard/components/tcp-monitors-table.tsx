/**
 * Table listing the team's TCP monitors on the dashboard. It renders an
 * empty-state with a create call-to-action when there are none, and otherwise a
 * horizontally scrollable table with name, endpoint, status, response-time, and
 * last-checked columns, delegating each row to `TcpMonitorTableRow`.
 *
