...
import type { Route } from "./+types/for.indie-hackers";
...
export default function ForIndieHackersPage({ loaderData }: Route.ComponentProps) {
		...
		<div className="min-h-screen bg-white dark:bg-neutral-950">
			...
			<LandingFeatures
				...
				features={[
					...
					},
					{
						...
						description:
							"Connect to Discord, Slack, Telegram, or any custom endpoint via webhooks.",
					},
					{
			...
			<LandingHowItWorks
				...
				steps={[
					...
					{
						title: "Get notified",
						description: "Receive alerts via email or webhooks when something goes wrong.",
					},
				]}
			/>
