		...
		privacy: {
			...
			sections: {
				...
				dataSharing: {
					...
					third: { label: "Resend:", body: "Envío de correos para alertas y notificaciones" },
					fourth: { label: "GitHub:", body: "Servicios de autenticación" },
					outro:
	...
	page: {
		...
		trial: {
			...
			refusal: {
				...
				rateLimitedFor: "Puedes ejecutar otra comprobación en {{seconds}} segundos.",
				budgetExhausted:
