			...
			{showArrow && (
				<OverlayArrow className="group">
					<svg
						...
						height={12}
						viewBox="0 0 12 12"
						className="group-placement-left:-rotate-90 group-placement-right:rotate-90 group-placement-bottom:rotate-180 dark:stroke-zinc-600 block fill-white stroke-black/10 stroke-1 dark:fill-[#1f1f21] forced-colors:fill-[Canvas] forced-colors:stroke-[ButtonBorder]"
					>
