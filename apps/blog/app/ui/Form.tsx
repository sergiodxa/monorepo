...
export type ValidationErrors = Parameters<typeof FormValidationContext.Provider>[0]["value"];
...
export function Form({ errors = {}, ...props }: FormProps) {
	return (
		<FormValidationContext.Provider value={errors}>
			<RemixForm {...props} className={twMerge("flex flex-col gap-4", props.className)} />
