...
const REDIRECTS = {
	...
	"remix-auth-return-to": "https://sergiodxa.com/articles/add-returnto-behavior-to-remix-auth",
	"cache-http-server": "https://sergiodxa.com/articles/http-vs-server-side-cache-in-remix",
	"cache-loader-route": "https://sergiodxa.com/articles/loader-vs-route-cache-headers-in-remix",
};
