...
export namespace Schemas {
	...
	export const FormDataEntryValueSchema = z.union([z.string(), z.instanceof(File)]).nullable();
	...
	export function formData() {
		return z.instanceof(FormData).transform((formData) => {
			...
			return z
				.array(z.tuple([z.string(), FormDataEntryValueSchema.or(FormDataEntryValueSchema.array())]))
