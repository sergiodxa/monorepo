...
export default {
	...
	home: {
		...
		feed: {
			...
			article: "I wrote about <articleLink>{{title}}</articleLink>",

			tutorial: "I published how to <tutorialLink>{{title}}</tutorialLink>",
	...
	articles: {
		...
		description: {
			search: "Showing {{count}} articles for the query <highlight>{{term}}</highlight>",
