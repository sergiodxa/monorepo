...
/**
 * Scopes every sign-in asks for. `offline_access` earns its place: it is what makes the
 ...
 * callback URL they are registered under, and a sign-in that names no destination lands on
 * the reading queue.
 *
